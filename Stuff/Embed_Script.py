import together
import pymongo
import RAG_Components.AIClasses as AIClasses
import re
...
print('Initialize')
query = "What is Alan Turing's Contributions to cryptography?"
BasePrompt = "You are an AI Bot who takes in a question and only returns a search query for a wikipedia title or topic lE.g. <User> What is the size of the Effiel Tower? </User> <AI> Effiel Tower </AI>"
